...
if env_hosts:
    ...
    ALLOWED_HOSTS = [
        ...
        'localhost', 
        '127.0.0.1',
        'qualified-pelican-fed-devo-5c8e5770.koyeb.app',
    ]
...
# Database
# https://docs.djangoproject.com/en/6.0/ref/settings/#databasesimport os
...
if IS_PRODUCTION:
    ...
    print("🚀 Running in PRODUCTION mode: Using Supabase PostgreSQL")
    ...
    print("🔧 Running in DEVELOPMENT mode: Using Local SQLite")
    
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.sqlite3',
            'NAME': os.path.join(BASE_DIR, 'media', 'db.sqlite3'), # Store DB in media folder
        }
    }
...
# --- ENVIRONMENT DETECTION ---
# Set this to 'true' in your Koyeb environment variables
# Set this to anything else (or empty) for local development
IS_PRODUCTION = os.getenv('IS_PRODUCTION', '').lower() in ('true', '1', 'yes')

# --- BASE DIR ---
# Ensure this points to the folder containing 'src_api'
# Assuming settings.py is in: federalism/src_api/fed_api/settings.py
BASE_DIR = Path(__file__).resolve().parent.parent

# --- MEDIA STORAGE CONFIGURATION ---
if IS_PRODUCTION:
    # --- PRODUCTION: SUPABASE (S3) ---
    print("🚀 Running in PRODUCTION mode: Using Supabase S3")
    
    # Use Supabase S3 backend
    DEFAULT_FILE_STORAGE = 'storages.backends.s3boto3.S3Boto3Storage'
    
    # Supabase Credentials (Required for Production)
    AWS_ACCESS_KEY_ID = os.environ.get('SUPABASE_S3_ACCESS_KEY_ID','90c5e783dda69413c813b49fdbfbc0a0')
    AWS_SECRET_ACCESS_KEY = os.environ.get('SUPABASE_S3_SECRET_ACCESS_KEY','723132c9d8f3931e48b120de87499567b1ee03c2b41cbbc149b5a7205d01777b')
    AWS_STORAGE_BUCKET_NAME = os.environ.get('SUPABASE_BUCKET_NAME', 'federalism-media')
    AWS_S3_ENDPOINT_URL = os.environ.get('SUPABASE_S3_ENDPOINT_URL', 'https://uiomawuiijsqkvesfjvf.storage.supabase.co/storage/v1/s3')
    ...
    # Supabase Buckets usually have path-style URLs
    AWS_S3_ADDRESSING_STYLE = 'path'
    
else:
    # --- DEVELOPMENT: LOCAL FILE SYSTEM ---
    print("🔧 Running in DEVELOPMENT mode: Using Local Storage")
    
    # Force Local Storage
    DEFAULT_FILE_STORAGE = 'django.core.files.storage.FileSystemStorage'
    
    # Point to your local media folder
    MEDIA_ROOT = os.path.join(BASE_DIR, 'media')
    MEDIA_URL = '/media/'
